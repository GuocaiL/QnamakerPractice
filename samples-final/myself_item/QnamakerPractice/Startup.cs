...
using MyController_middleware_SchedulerMiddleware;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddBot<EchoBot>(options =>
            {
              ...
              //  options.Middleware.Add(new ConversationState<ControllerAdministratorSetings>(dataStore));
                options.Middleware.Add(new SchedulerMiddleware());
